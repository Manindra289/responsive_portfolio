...
const CategoryItem = (props) => {
  ...
  return (
    ...
    <div>
        <button onClick={Changeblg} className={[' hover:bg-green-500 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 box-content mt-4 w-[100%] rounded-lg drop-shadow-2xl max-sm:py-2 bg-white '].join(' ')}>
