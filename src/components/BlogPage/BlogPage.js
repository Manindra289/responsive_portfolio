  ...
  return (
    <div className=' w-[100vw] lg:grid-rows-1 lg:grid-cols-1 grid grid-cols-1'>
      ...
      <div className='lg:row-span-1 col-span-9'>
            <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] font-bold'>Blogs Category</h1>
      ...
      <div className='flex flex-col '>
          <ul>
          {
            colnar.map((collection,index)=>(
              <li key={index}>
                <CategoryItem title={collection} setblog_visible={setblog_visible}  blog={blog} setblog={setblog} setcoln = {setcoln} index = {index} />
                </li>
            ))
          }
          </ul>
      ...
      {blog_visible===false ?
          <div className='lg:row-span-1 lg:col-span-9 sm:w-[100%]'>
            <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] font-bold'>{coln}</h1>
