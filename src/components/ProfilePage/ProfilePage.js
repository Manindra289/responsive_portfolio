      ...
      <div className=' max-lg:flex max-lg:mb-10 lg:mb-10 max-lg:flex-col lg:grid lg:grid-rows-8 lg:grid-cols-12 max-lg:mt-14 mt-16 justify-self-center lg:h-[85vh] min-h-[650px] w-[85vw]  max-w-[1360px] lg:max-h-[700px] smallest_scn ' >
          ...
          <hr className='border-white align-middle mx-4'/>
            ...
            <div className='grid grid-cols-1 mt-4 px-2'>
              ...
              <h1  className=' text-green-500 font-bold max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] py-1.5  max-sm:py-1 '>Name</h1>
              <hr className='border-white align-middle mx-5'/>
              <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] py-1.5 max-sm:py-1'>Manindra Khandyana</h1>
              </div>
              <div className={['mt-4 rounded-lg drop-shadow-2xl mx-2 max-sm:py-2 ', styles['bg']].join(' ')}>
              <h1  className=' text-green-500 font-bold max-sm:p-0 p-[0.1rem]  pl-0 max-sm:text-base text-xl ml-[1.5rem] py-1.5 max-sm:py-1 '>About</h1>
              <hr className='border-white align-middle mx-5'/>
              <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] py-1.5 max-sm:py-1'>Student</h1>
              </div>
            </div>
          </div>
          <div className='lg:row-span-8 lg:col-span-8 mt-5 mb-10 box-border'>
            <div className={[' h-[100%] w-[1fr] rounded-3xl drop-shadow-2xl mx-6 pt-2 ', styles['bg']].join(' ')}>
              ...
              <div className='pt-5'>
                <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] font-bold'>Description</h1></div>
              <div>

              <p className={['text-white max-lg:mb-5 lg:text-sm ml-6 mr-6 max-lg:text-sm mb-2 text-justify pt-2'].join(' ')}>
             ...
             <div className='lg:absolute lg:bottom-0'>
              ...
              <h1  className=' text-white max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-xl ml-[1.5rem] font-bold'>Interested In</h1>
              <hr className='border-white align-middle mx-4'/>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2'>
                ...
                <h1 className={['mb-1 pt-2 align-middle text-white text-md font-bold  text-center mt-2 max-lg:text-lg  max-lg:pt-2',styles['ah1']].join(' ')}>React development</h1>
              </div>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2'>
                ...
                <h1 className={['mb-1 pt-2 align-middle text-white text-md font-bold  text-center mt-2 max-lg:text-lg max-lg:pt-2',styles['ah1']].join(' ')}>Machine Learning</h1>
              </div>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2 flex flex-col max-lg:justify-between ' >
                ...
                <h1 className={['mb-1 pt-2 align-middle text-white text-md font-bold  text-center mt-2 max-lg:text-lg max-lg:pt-2',styles['ah1']].join(' ')}>Backend development</h1>
              </div>
              ...
              <div className='flex justify-center '>
                ...
                <h1 className={['mb-1 pt-2 align-middle text-white text-md font-bold  text-center mt-2 max-lg:text-lg  max-lg:pt-2',styles['ah1']].join(' ')}>Compitative Programming</h1>
              </div>

              <div className='flex col-span-full justify-center   text-pink-500 max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-3xl ml-[1.5rem] font-bold '>
