      ...
      <div className=' max-lg:flex max-lg:flex-col lg:grid lg:grid-rows-8 lg:grid-cols-12 max-lg:mt-14 lg:self-center justify-self-center lg:h-[85vh] w-[85vw] smallest_scn' >
          ...
          <hr className='border-white align-middle mx-4'/>
            ...
            <div className='grid grid-cols-1 mt-4 px-2'>
              <div className='justify-self-center'>
                <img src={myImg} className='h-60 w-60 rounded-full border-4 border-green-300 drop-shadow-2xl'/>
              </div>
          ...
          <div className='lg:row-span-8 lg:col-span-8 mt-5 mb-10 box-border'>
            <div className={[' h-[100%] w-[1fr] rounded-3xl drop-shadow-2xl mx-6 pt-2 ', styles['bg']].join(' ')}>
              ...
              <div className='flex mt-8 2xl:text-5xl text-green-500 max-sm:p-0 p-[0.1rem] pl-0 max-sm:text-base text-3xl ml-[1.5rem] font-bold '>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2'>
                <div className='flex justify-center'>
                  <img src={webImgp} className='object-cover  w-32 h-24 rounded-2xl max-lg:w-[100%] max-lg:h-[80%]' />
                </div>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2'>
                <div className='flex justify-center'>
                  <img src={mlImg} className='object-cover  w-32 h-24 rounded-2xl max-lg:w-[100%] max-lg:h-[80%]' />
                </div>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2 flex flex-col justify-between' >
                <div className='flex justify-center'>
                  <img src={backendImg} className='object-cover  w-32 h-24 rounded-2xl max-lg:w-[100%] max-lg:h-[80%]' />
                </div>
                <h1 className={['mb-1 pt-2 align-middle text-white text-md font-bold  text-center mt-2 max-lg:text-lg 2xl:text-5xl max-lg:pt-2',styles['ah1']].join(' ')}>Backend Image</h1>
              </div>
              ...
              <div className=' border-white border-2 justify-self-center rounded-2xl box-border p-2 '>
              <div className='flex justify-center '>
                <img className='object-cover  w-32 h-24 rounded-2xl max-lg:w-[100%] max-lg:h-[80%]' src={cmpImg} />
                </div>
