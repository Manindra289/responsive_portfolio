  ...
  return (
    ...
    <section className={['lg:grid lg:relative max-lg:pb-2 lg:box-border w-[100%] h-[100%] rounded-3xl lg:overflow-scroll mb-2',styles['bg']].join(' ')}>
      ...
      <div className='lg:overflow-scroll '>
        <p className={['text-white lg:text-sm ml-6 mr-4 max-lg:text-sm mb-2 text-justify  pt-2'].join(' ')}>
        ...
        <div className={[' lg:my-2 2xl:bottom-6 lg:text-sm max-lg:pb-4',styles['l_and_c']].join(' ')}>
